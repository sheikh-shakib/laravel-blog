        ...
        <div class="col-md-12 col-lg-10">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="@if ($post->user->image)
                {{asset($post->user->image)}}
                @else
                {{asset('web')}}/images/user.png
              @endif" alt="Image" class="img-fluid"></figure>
    ...
    <div class="container">
      ...
      <div class="row blog-entries element-animate">
        ...
        <div class="col-md-12 col-lg-8 main-content">
          ...
          <div class="pt-5">
            <p>
              Categories:  <a href="{{route('web.category',['slug'=>$post->category->slug])}}">{{$post->category->name}},</a>  
              @if ($post->tags()->count())
              Tags:
                @foreach ($post->tags as $tag)
                   <a href="{{route('web.tag',['slug'=>$tag->slug])}}">{{$tag->name}}</a>,
                @endforeach  
              @endif
            </p>
          </div>
          ...
          <div class="pt-5">
            ...
            {{-- <ul class="comment-list">
              <li class="comment">
                <div class="vcard">
                  <img src="{{asset('web')}}/images/person_1.jpg" alt="Image placeholder">
                </div>
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="sidebar-box">
            ...
            <ul class="tags">
              @foreach ($tags as $tag)
                <li><a href="{{route('web.tag',['slug'=>$tag->slug])}}">{{$tag->name}}</a></li>  
              @endforeach
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-7">
          ...
          <div class="two-col d-block d-md-flex justify-content-between">
            @foreach ($firstrelatedposts as $post)
              <a href="{{route('post',['slug'=>$post->slug])}}" class="hentry v-height img-2 gradient" style="background-image: url('{{$post->image}}');">
...
<script>
    ...
    s.src = 'https://laravel-blog-wmw4cpeydf.disqus.com/embed.js';
